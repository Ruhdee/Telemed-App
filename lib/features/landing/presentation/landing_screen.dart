        ...
        child: SafeArea(
          child: CustomScrollView(
            slivers: [
              ...
              // ── Hero Section ───────────────────────────────────
              SliverToBoxAdapter(child: _HeroSection(onRegister: onRegister)),
      ...
      child: Column(
        ...
        children: [
          ...
          Text.rich(
                ...
                style: Theme.of(
                  context,
                ).textTheme.displayLarge?.copyWith(height: 1.15),
              )
              .animate()
          ...
          Wrap(
            ...
            runSpacing: 12,
            children:
                ['Generic Hospital', 'MediCross', 'HealthPlus', 'GlobalCare']
                    .map(
                      (name) => Text(
                        name,
                        style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    final services = [
      _ServiceItem(
        ...
        titleKey: 'generalConsultation',
        descKey: 'generalConsultationDesc',
      ...
      _ServiceItem(
        ...
        gradient: [const Color(0xFFF472B6), const Color(0xFFDB2777)],
      ),
      _ServiceItem(
      ...
      _ServiceItem(
        ...
        titleKey: 'dermatology',
        descKey: 'dermatologyDesc',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            loc.translate('ourServices'),
            style: Theme.of(context).textTheme.displayMedium,
          ),
          const SizedBox(height: 8),
          Text(
            loc.translate('expertCareAtYourFingertips'),
  ...
  Widget build(BuildContext context) {
    ...
    final steps = [
      (
        ...
        loc.translate('createAccountDesc'),
        Icons.person_add_outlined,
      ),
      (
        loc.translate('chooseSpecialist'),
        loc.translate('chooseSpecialistDesc'),
        Icons.medical_services_outlined,
      ),
      (
        loc.translate('bookAndConsult'),
        loc.translate('bookAndConsultDesc'),
        Icons.videocam_outlined,
      ),
      (
        loc.translate('getTreatment'),
        loc.translate('getTreatmentDesc'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            loc.translate('simpleStepsToGetStarted'),
            style: Theme.of(
              context,
...
class _TestimonialsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final testimonials = [
      (
        loc.translate('testimonial1'),
        loc.translate('testimonial1Author'),
        loc.translate('patient'),
      ),
      (
        loc.translate('testimonial2'),
        loc.translate('testimonial2Author'),
        loc.translate('patient'),
      ),
      (
        loc.translate('testimonial3'),
        loc.translate('testimonial3Author'),
        loc.translate('patient'),
      ),
    ];
        ...
        children: [
          RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(
                  text: loc.translate('appBrandingCare'),
