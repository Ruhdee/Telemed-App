...
/// Patient Video Call Screen - Clean implementation following flutter_webrtc best practices
///
...
class _PatientVideoCallScreenState extends State<PatientVideoCallScreen>
  ...
  Future<void> _initialize() async {
    try {
      ...
      print('[PatientVideo] Renderers initialized');
      ...
      setState(() {
        _isInitialized = true;
        _statusText = 'Waiting for doctor...';
      });
      print('[PatientVideo] Initialization complete');
    } catch (e) {
      print('[PatientVideo] ERROR during initialization: $e');
      setState(() {
  ...
  Future<void> _getUserMedia() async {
    try {
      ...
      print(
        '[PatientVideo] Got user media - Audio tracks: ${stream.getAudioTracks().length}, Video tracks: ${stream.getVideoTracks().length}',
      );
    } catch (e) {
      print('[PatientVideo] ERROR getting user media: $e');
  ...
  Future<void> _connectSignaling() async {
    ...
    _socket!.onConnect((_) {
      ...
      print('[PatientVideo] Joined room: ${widget.roomId}');
    });

    _socket!.on('user-connected', (userId) {
      print('[PatientVideo] User connected: $userId');
      _remotePeerId = userId.toString();
      _call(userId.toString());
    });

    _socket!.on('offer', (data) async {
      print('[PatientVideo] Received offer');
      await _handleOffer(data);
    });

    _socket!.on('answer', (data) async {
      print('[PatientVideo] Received answer');
      await _handleAnswer(data);
    });

    _socket!.on('ice-candidate', (data) async {
      print('[PatientVideo] Received ICE candidate');
    ...
    _socket!.onConnectError((error) {
      print('[PatientVideo] Connection error: $error');
    });
  ...
  Future<RTCPeerConnection> _createPeerConnection() async {
    print('[PatientVideo] Creating peer connection');
    ...
    pc.onTrack = (event) {
      print(
        '[PatientVideo] onTrack - Received remote ${event.track.kind} track',
      );
    ...
    pc.onIceCandidate = (candidate) {
      if (candidate != null && _remotePeerId != null) {
        print('[PatientVideo] Sending ICE candidate');
  ...
  Future<void> _call(String targetUserId) async {
    try {
      ...
      print('[PatientVideo] Offer sent');
    } catch (e) {
      print('[PatientVideo] ERROR creating offer: $e');
    }
  }
  ...
  Future<void> _handleOffer(dynamic data) async {
    try {
      ...
      print('[PatientVideo] Answer sent to: $callerId');
    } catch (e) {
      print('[PatientVideo] ERROR handling offer: $e');
    }
  }
  ...
  Future<void> _handleAnswer(dynamic data) async {
    try {
      ...
      print('[PatientVideo] Remote description set');
    } catch (e) {
      print('[PatientVideo] ERROR handling answer: $e');
    }
  }
  ...
  Future<void> _handleIceCandidate(dynamic data) async {
    try {
      ...
      print('[PatientVideo] ICE candidate added');
    } catch (e) {
      print('[PatientVideo] ERROR adding ICE candidate: $e');
    }
  }
  ...
  void _toggleMic() {
    if (_localStream != null) {
      ...
      print('[PatientVideo] Mic ${_isMicMuted ? "muted" : "unmuted"}');
    }
  }
  ...
  void _toggleCamera() {
    if (_localStream != null) {
      ...
      print('[PatientVideo] Camera ${_isCameraOff ? "off" : "on"}');
    }
  }
